...
export function AnimatedPinDemo() {
  return (
    <div className="h-full w-full flex flex-col lg:flex-row gap-12 lg:gap-44 items-center justify-center ">
      <Link target="_blank" href="https://crypto-hippo.vercel.app">
        <PinContainer
          title="/crypto-hippo"
          href="https://crypto-hippo.vercel.app"
        >
          <div className="flex basis-full flex-col p-4 tracking-tight text-slate-100/50 sm:basis-1/2 w-[20rem] h-[20rem] lg:w-[32rem] lg:h-[24rem] ">
